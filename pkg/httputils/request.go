...
// BindJSON provides a common implementation of JSON unmarshalling with well defined error handling.
func BindJSON(w http.ResponseWriter, r *http.Request, data interface{}) (int, error) {
